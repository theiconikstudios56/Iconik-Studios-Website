    ...
    <>
      <nav className="fixed top-0 left-0 w-full z-50 p-6 flex justify-between items-center pointer-events-none">
        ...
        <div className="flex-1 lg:flex-none flex items-center justify-end gap-5 pointer-events-auto">
          ...
          <button
            onClick={toggleMenu}
            className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center transition-colors text-paper"
          >
